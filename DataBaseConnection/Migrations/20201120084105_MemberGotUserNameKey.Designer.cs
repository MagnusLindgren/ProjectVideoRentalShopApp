...
namespace DataBaseConnection.Migrations
{
    ...
    [Migration("20201120084105_MemberGotUserNameKey")]
    partial class MemberGotUserNameKey
    {
            ...
            modelBuilder.Entity("DataBaseConnection.Rental", b =>
                {
                    ...
                    b.Property<string>("RentedByUsername")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("DataBaseConnection.Rental", b =>
                {
                    ...
                    b.HasOne("DataBaseConnection.Member", "RentedBy")
                        .WithMany("Rentals")
                        .HasForeignKey("RentedByUsername");

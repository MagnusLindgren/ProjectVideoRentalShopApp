        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MoiviesId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActorMovie", x => new { x.ActorsId, x.MoiviesId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_ActorMovie_Movies_MoiviesId",
                        column: x => x.MoiviesId,
